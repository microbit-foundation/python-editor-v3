...
const en = {
  alerts: {
    ...
    module_added:
      'The "{{module_name}}" module has been added to the filesystem.',
    module_out_of_space:
      "Could not add file to the system as there is no storage space left.",
  },
  help: {
    "docs-link": {
  ...
  confirms: {
    ...
    blocks:
      "You have unsaved code. Using blocks will change your code. You may lose your changes. Do you want to continue?",
  ...
  webusb: {
    err: {
      "update-req":
        'You need to <a target="_blank" href="https://microbit.org/firmware/">update your micro:bit firmware</a> to make use of this feature.',
      "update-req-title": "Please update the micro:bit firmware",
      "clear-connect":
        "Another process is connected to this device.<br>Close any other tabs that may be using WebUSB (e.g. MakeCode, Python Editor), or unplug and replug the micro:bit before trying again.",
      "reconnect-microbit": "Please reconnect your micro:bit and try again.",
      "partial-flashing-disable":
        "If the errors persist, try disabling Quick Flash in the beta options.",
    ...
    "flashing-long-msg":
      "Initial flash might take longer, subsequent flashes will be quicker.",
  ...
  load: {
    ...
    "file-help-text":
      "The Project Files area shows you the files included in your program and lets you add or remove external python modules and other files. Find out more in the ",
