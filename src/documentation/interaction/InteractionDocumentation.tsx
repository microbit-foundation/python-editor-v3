...
const InteractionDocumentation = ({ ideas }: IdeasDocumentationProps) => {
  const [anchor, setAnchor] = useRouterTabSlug("interaction");
...
const ActiveLevel = ({
  ...
  const intl = useIntl();
  const headingString = intl.formatMessage({ id: "interaction-tab" });
  ...
  return (
    <HeadedScrollablePanel
      ...
      heading={
        <AreaHeading
          name={headingString}
          description={intl.formatMessage({ id: "interaction-tab-description" })}
        />
      }
    >
